    ...
    <ScrollWrapper>
      ...
      >
        ...
        >
          <ShortestPathProject />
          <h1
            className="display-light-italic s-48"
            style={{
              letterSpacing: "1px",
              margin: 0,
              marginTop: "40px",
          ...
          <p className="regular s-12">May 21, 2024</p>
        </div>
        <div
          style={{
            margin: "50px auto",
        ...
        >
          <Grid spacing={5}>
            <Grid id="spp-paragraph-1" item xs={12} sx={{ marginBottom: "100px" }}>
              <h1 className="display-light-italic">History</h1>
              <div className="regular s-12" style={{ textAlign: "left" }}>
                In graph theory, the shortest path problem is the problem of finding a path between two vertices (or nodes) in a graph such that the sum of the weights of its constituent edges is minimized. The problem of finding the shortest path between two intersections on a
                road map may be modeled as a special case of the shortest path problem in graphs, where the vertices correspond to intersections and the edges correspond to road segments, each weighted by the length of the segment.
              </div>
            </Grid>
            <Grid id="spp-paragraph-1" item xs={12}>
              <h1 className="display-light-italic">How does it work?</h1>
              <p className="regular s-12" style={{ textAlign: "left" }}>
              ...
              <p className="regular s-12" style={{ textAlign: "left", marginBottom: "100px" }}>
            ...
            <Grid id="spp-paragraph-1" item xs={12}>
              <h1 className="display-light-italic">Algorithms</h1>
              <div className="regular s-12" style={{ textAlign: "left" }}>
                <p>
